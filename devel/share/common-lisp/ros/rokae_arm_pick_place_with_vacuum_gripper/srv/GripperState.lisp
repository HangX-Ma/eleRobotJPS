...
(cl:in-package rokae_arm_pick_place_with_vacuum_gripper-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GripperState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rokae_arm_pick_place_with_vacuum_gripper-srv:<GripperState-request> is deprecated: use rokae_arm_pick_place_with_vacuum_gripper-srv:GripperState-request instead.")))

(cl:ensure-generic-function 'switch_state-val :lambda-list '(m))
(cl:defmethod switch_state-val ((m <GripperState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rokae_arm_pick_place_with_vacuum_gripper-srv:switch_state-val is deprecated.  Use rokae_arm_pick_place_with_vacuum_gripper-srv:switch_state instead.")
  (switch_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GripperState-request>)))
  ...
  "rokae_arm_pick_place_with_vacuum_gripper/GripperStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperState-request)))
  "Returns string type for a service object of type 'GripperState-request"
  "rokae_arm_pick_place_with_vacuum_gripper/GripperStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GripperState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rokae_arm_pick_place_with_vacuum_gripper-srv:<GripperState-response> is deprecated: use rokae_arm_pick_place_with_vacuum_gripper-srv:GripperState-response instead.")))

(cl:ensure-generic-function 'feedback-val :lambda-list '(m))
(cl:defmethod feedback-val ((m <GripperState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rokae_arm_pick_place_with_vacuum_gripper-srv:feedback-val is deprecated.  Use rokae_arm_pick_place_with_vacuum_gripper-srv:feedback instead.")
  (feedback m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GripperState-response>)))
  ...
  "rokae_arm_pick_place_with_vacuum_gripper/GripperStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperState-response)))
  "Returns string type for a service object of type 'GripperState-response"
  "rokae_arm_pick_place_with_vacuum_gripper/GripperStateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperState)))
  ...
  "rokae_arm_pick_place_with_vacuum_gripper/GripperState")