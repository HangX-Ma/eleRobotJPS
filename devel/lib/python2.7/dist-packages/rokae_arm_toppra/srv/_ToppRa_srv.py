...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.ifSave,) = _get_struct_B().unpack(str[start:end])
      self.ifSave = bool(self.ifSave)
      return self
...
class ToppRa_srv(object):
  ...
  _md5sum = '7cd293dc242907880f3bae1412ae9b57'
